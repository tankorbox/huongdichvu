...
public class DienThoai {
	...
	public DienThoai(int id, String ten, String hinhanh, int id_hangsanxuat,
		...
		this.id_hangsanxuat = id_hangsanxuat;
	...
	public int getId_hangsanxuat() {
		return id_hangsanxuat;
	}

	public void setId_hangsanxuat(int id_hangsanxuat) {
		this.id_hangsanxuat = id_hangsanxuat;
	}
